...
chisqrd = sum(((ydata - func3(xdata,ans_Hu,ans_O_m,ans_O_L))**2)/(sum(func3(xdata,ans_Hu,ans_O_m,ans_O_L))))
...
print('The value for the reduced \u03C7\u00b2 value as normally done is:',normchisqrd )
